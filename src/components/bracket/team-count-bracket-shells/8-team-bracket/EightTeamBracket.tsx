      ...
      <div className="match-row top-row ">
        <div className="round1-column">
          <div className="match-cell lower-line">
            ...
            <input className="team-input" placeholder="Team 8" />
        ...
        <div className="match-cell lower-match-col4">
          <input className="team-input" placeholder="Winner of 12" />
          <input className="team-input" placeholder="Winner of losers" />
          <span className="match-number">Match 14</span>
        </div>
        ...
        <div className="match-cell lower-match-col4 no-dash">
          ...
          />
          <span className="match-number">Match 15</span>
        </div>
      </div>
      ...
      <div className="match-row bottom-row">
        ...
        <div className="round1-column">
          <div className="match-cell lower-line single-cell">
            <input className="team-input" placeholder="Loser of 8" />
          ...
          <div className="match-cell upper-line single-cell">
            <input className="team-input" placeholder="Loser of 7" />
        ...
        <div className="match-cell lower-match-col upper-line single-cell">
          ...
          <span className="match-number">Match 11</span>
        </div>

        <div className="match-cell upper-line angle-up90 single-cell">
          <input className="team-input" placeholder="Loser of 12" />
          <input className="team-input" placeholder="Winner of 11" />
