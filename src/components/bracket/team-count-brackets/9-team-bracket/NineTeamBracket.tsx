...
export default function NineTeamBracket({
  ...
  const showModal = (matchNum: number) => {
    ...
    switch (matchNum) {
      ...
      case 5:
        ...
        break;
      case 6:
        if (!matchResults[1].loser || !matchResults[4].loser) {
          return message.error("Need loser from Match 1 & 4 first.");
        }
        A = matchResults[1].loser;
        B = matchResults[4].loser;
        break;
      case 7:
        if (!matchResults[2].loser || !matchResults[5].loser) {
          return message.error("Need loser from Match 2 & 5 first.");
        }
        A = matchResults[2].loser;
        B = matchResults[5].loser;
        break;
      case 8:
        if (!matchResults[3].loser || !matchResults[6].winner) {
          return message.error("Need winner from Match 6 & loser of 3 first.");
        }
      ...
      case 9:
        ...
        break;
      case 10:
        if (!matchResults[5].winner || !matchResults[2].winner) {
          return message.error("Need winner from Match 5 & 2 first.");
        }
        A = matchResults[5].winner;
        B = matchResults[2].winner;
        break;
      case 11:
        if (!matchResults[9].loser || !matchResults[7].winner) {
          return message.error("Need winner from Match 7 & loser of 9 first.");
        }
        A = matchResults[9].loser;
        B = matchResults[7].winner;
        break;
      case 12:
        if (!matchResults[10].loser || !matchResults[8].winner) {
          return message.error("Need winner from Match 8 & loser of 10 first.");
        }
        A = matchResults[10].loser;
        B = matchResults[8].winner;
        break;
      case 13:
        if (!matchResults[12].winner || !matchResults[11].winner) {
          return message.error("Need winner from Match 12 & 11 first.");
        }
      ...
      case 14:
        ...
        break;
      case 15:
        if (!matchResults[14].loser || !matchResults[13].winner) {
          return message.error(
            "Need winner from Match 13 & loser of 14 first."
          );
        }
        A = matchResults[14].loser;
        B = matchResults[13].winner;
        break;
      case 16:
        if (!matchResults[15].winner || !matchResults[14].winner) {
          return message.error("Need winner from Match 14 & losers first.");
        }
        A = matchResults[14].winner;
        B = matchResults[15].winner;
        break;
      case 17:
  ...
  const semiWinner = matchResults[14]?.winner;
  const grandWinner = matchResults[16]?.winner;
  const resetWinner = matchResults[17]?.winner;
  ...
  return (
    <div className="bracket-shell">
      ...
      <div className="match-row top-row ">
        ...
        {/* round 3 */}
        <div className="round1-column">
          <div className="match-cell lower-match-col lower-line angle-down45">
            <TeamSlot
        ...
        <div className="match-cell lower-line lower-match-col3">
          <TeamSlot
        ...
        <div className="match-cell lower-match-col4">
          ...
          />
          <TeamSlot
            value={renderTeamName(matchResults[15].winner)}
            placeholder="Winner of losers"
            title={
              renderTeamName(matchResults[15].winner)
                ? "Winner of losers"
                : undefined
            }
          />
          <span className="match-number">
            Match 16 <TrophyFilled onClick={() => showModal(16)} />
          </span>
        </div>
          ...
          <div className="match-row">
            <div className="match-cell lower-match-col4 no-dash">
              <TeamSlot
                ...
                placeholder="Winner of 16"
                title={
                  renderTeamName(matchResults[16].winner)
                    ? "Winner of 16"
                    : undefined
                }
              />
              <TeamSlot
                value={renderTeamName(matchResults[16].loser)}
                placeholder="Loser of 16 (if necessary)"
                title={
                  renderTeamName(matchResults[16].loser)
                    ? "loser of 16"
                    : undefined
                }
              />
      ...
      <div className="match-row bottom-row">
        ...
        <div className="round1-column">
          ...
          <div className="match-cell upper-line single-cell">
            <TeamSlot
              value={renderTeamName(matchResults[9].loser)}
              placeholder="Loser of 9"
              title={
                renderTeamName(matchResults[9].loser) ? "loser of 9" : undefined
              }
            />
            <TeamSlot
        ...
        <div className="match-cell upper-line angle-up90 single-cell">
          <TeamSlot
            ...
            placeholder="Loser of 14"
            title={
              renderTeamName(matchResults[14].loser) ? "Loser of 14" : undefined
            }
          />
          <TeamSlot
            value={renderTeamName(matchResults[13].winner)}
            placeholder="Winner of 13"
            title={
      ...
      <WhoWonModal
        ...
        downstream={
          currentMatch !== null
            ? downstreamOf(currentMatch, 9, teams, matchResults)
            : []
        }
      />
